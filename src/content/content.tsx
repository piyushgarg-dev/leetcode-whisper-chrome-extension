...
function ChatBox({ context }: ChatBoxProps) {
  ...
  return (
    <div className="w-[400px] h-[550px] mb-2 rounded-2xl relative text-wrap overflow-auto bg-[rgba(0,0,0,0.2)]">
      <div className="h-[500px] overflow-y-auto  p-4 mb-10" ref={chatBoxRef}>
        {chatHistory.map((message, index) => (
          <div
            key={index.toString()}
            className="flex gap-4 mt-3  text-wrap rounded-xl p-3 bg-black text-white"
          >
            <Avatar>
      ...
      <div className="absolute bottom-0 w-full flex items-center gap-2">
        <Input
          ...
          className="rounded-lg bg-black p-3 my-2 ml-2"
