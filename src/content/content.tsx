...
const ContentPage: React.FC = () => {
  ...
  const languageElement = document.querySelector("div[data-keybinding-context='1']");
  let Language;

  if (languageElement) {
    Language = languageElement.getAttribute("data-mode-id");
  } else {
    console.log("Element with data-keybinding-context='1' not found.");
  }
